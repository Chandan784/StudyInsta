...
public class NotificatiosAdapter extends RecyclerView.Adapter<NotificatiosAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public NotificatiosAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NotificatiosAdapter.ViewHolder holder, int position) {


        holder.setData(list.get(position).title, list.get(position).body, list.get(position).dateValue);
    }
